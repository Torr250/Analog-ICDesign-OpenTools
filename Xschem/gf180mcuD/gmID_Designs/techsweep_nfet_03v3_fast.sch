  ...
  foreach var2 $&vg_vec
    ...
    foreach var3 $&vd_vec
      ...
      foreach var4 $&vb_vec
        alter vb $var4
        run
        wrdata techsweep_nfet_03v3_fast.txt noise1.all
        destroy all
        set appendwrite
...
op
show
write techsweep_nfet_03v3_fast.raw
.endc
"}
...
tclcommand="xschem raw_read $netlist_dir/techsweep_nfet_03v3_fast.raw; set show_hidden_texts 1; xschem annotate_op"}
