...
# read ngspice data
df_raw = pd.read_csv('./simulation/techsweep_'+devices[choice]+'_fast.txt', sep='\s+')
...
dic = {
  ...
  "CORNER": "Fast-Fast Low Temperature",
  "TEMP": -40.0,
  "VGS": vgs,
  "VDS": vds,
  "VSB": vsb,
...
savemat('./simulation/'+devices[choice]+'_fast.mat', {devices[choice]: dic})
