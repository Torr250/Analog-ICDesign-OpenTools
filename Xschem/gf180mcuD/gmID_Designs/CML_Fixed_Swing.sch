...
T {tcleval(GBW: [to_eng [xschem raw value gbw 0]] dB)} 180 -370 0 0 0.3 0.3 {floater=1}
...
N -40 0 -40 40 {lab=Vx}
N -40 40 180 40 {lab=Vx}
N 180 0 180 40 {lab=Vx}
N -140 -30 -80 -30 {lab=INP}
N 220 -30 270 -30 {lab=INN}
N -40 -30 180 -30 {lab=0}
N 70 -30 70 -0 {lab=0}
N 70 40 70 110 {lab=Vx}
N -40 140 30 140 {lab=VBN}
N 70 140 140 140 {lab=0}
N 140 140 140 200 {lab=0}
N 70 200 140 200 {lab=0}
N 70 170 70 200 {lab=0}
N 70 200 70 230 {lab=0}
...
C {symbols/nfet_03v3.sym} 50 140 0 0 {name=M3
L=0.7u
W=35u
nf=1
m=2
...
C {gnd.sym} 70 230 0 0 {name=l8 lab=0}
...
C {lab_wire.sym} -330 60 0 0 {name=p7 sig_type=std_logic lab=Vx1}
C {lab_wire.sym} 40 40 0 0 {name=p8 sig_type=std_logic lab=Vx}
C {lab_wire.sym} -10 140 0 0 {name=p9 sig_type=std_logic lab=VBN}
