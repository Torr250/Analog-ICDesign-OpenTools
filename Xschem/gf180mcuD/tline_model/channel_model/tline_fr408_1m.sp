...
*
* Pérdida ajustada: 0.000 dB en DC, 12.000 dB @ 2.0000 GHz, 35.000 dB @ 8.0000 GHz
* fp1=1.558161 GHz   fp2=8.606354 GHz   (por etapa, x3 etapas)
*
...
* ============================================================
.subckt tline_fr408_1m in out
Ebuf_in1 mid_in1 0 in 0 1
R1 mid_in1 mid_r1 1.021428e+02
C1 mid_r1 0 1.000000e-12
Bshelf1 shelf_out1 0 V = V(mid_r1) + (V(mid_in1)-V(mid_r1))*0.181047788
Ebuf_in2 mid_in2 0 shelf_out1 0 1
R2 mid_in2 mid_r2 1.021428e+02
C2 mid_r2 0 1.000000e-12
Bshelf2 shelf_out2 0 V = V(mid_r2) + (V(mid_in2)-V(mid_r2))*0.181047788
Ebuf_in3 mid_in3 0 shelf_out2 0 1
R3 mid_in3 mid_r3 1.021428e+02
C3 mid_r3 0 1.000000e-12
Bshelf3 shelf_out3 0 V = V(mid_r3) + (V(mid_in3)-V(mid_r3))*0.181047788
