...
N 970 230 1030 230 {lab=in}
N 1150 230 1230 230 {lab=fr4_1m}
N 970 150 1030 150 {lab=in}
N 1150 150 1230 150 {lab=nelco_20in}
N 970 70 1030 70 {lab=in}
N 1150 70 1230 70 {lab=nelco_12in}
...
.control
  ...
  tran 10p 100n 
  option remzerovec
  write TB_channel_model_TRAN.raw
  write /foss/designs/gf180mcuD/eye_diagram/TB_channel_model_TRAN.raw
.endc
"}
...
C {lab_wire.sym} 1220 230 0 0 {name=p7 sig_type=std_logic lab=fr4_1m}
C {code_shown.sym} 1540 -210 0 0 {name=s1 only_toplevel=false value="
...
"}
C {lab_wire.sym} 1220 150 0 0 {name=p8 sig_type=std_logic lab=nelco_20in}
C {lab_wire.sym} 1220 70 0 0 {name=p9 sig_type=std_logic lab=nelco_12in}
C {channel_model/nelco4000_13_12inch.sym} 1050 100 0 0 {name=x1}
C {channel_model/nelco4000_13_20inch.sym} 1050 180 0 0 {name=x2}
C {channel_model/fr408_1m.sym} 1050 260 0 0 {name=x3}
C {lab_wire.sym} 970 230 0 0 {name=p10 sig_type=std_logic lab=in}
C {lab_wire.sym} 970 150 0 0 {name=p11 sig_type=std_logic lab=in}
C {lab_wire.sym} 970 70 0 0 {name=p12 sig_type=std_logic lab=in}
