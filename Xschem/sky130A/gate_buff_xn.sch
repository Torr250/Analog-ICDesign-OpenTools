...
C {code_shown.sym} -330 -130 0 0 {name=SPICE only_toplevel=false 
value="
.param nfing=1
"}
C {gate_not_xn.sym} -100 0 0 0 {name=X1 nfing='nfing'}
C {gate_not_xn.sym} 60 0 0 0 {name=X2 nfing='nfing'}
